      ...
      <div className="Prime-container center">
        ...
        <div className='Prime-building'>
          ...
          <div className="PrimeText2">
            <h2>Your partner in transforming ideas into <br/> stunning visuals.</h2>
          </div>
          <div className='PrimeText3'>
            <span className='span1'>Branding Design</span><strong> - </strong>
            <span className='span2' >Graphics Design</span><strong> - </strong>
        ...
        <form className="form">
          ...
          <textarea type="text" placeholder="Message"/>
            ...
            <input className='checkbox' type="checkbox" required /> I accept the terms and conditions
            </div>
          <button>Send</button>
        </form>
      </div>
